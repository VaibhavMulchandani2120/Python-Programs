...
def search_data():
    ...
    e_mobile.delete(0,'end')
    if e_id.get=="":
        msg.showinfo("Search Statu","Id is Mandatory")
    else:
        conn=create_conn()
        cursor=conn.cursor()
...
insert=Button(root,text="INSERT",bg="grey",fg="blue",font=("Arial",10),command=insert_data)
insert.place(x=20,y=300)

search=Button(root,text="SEARCH",bg="grey",fg="blue",font=("Arial",10),command=search_data)
search.place(x=80,y=300)

update=Button(root,text="UPDATE",bg="grey",fg="blue",font=("Arial",10),command=update_data)
update.place(x=148,y=300)

delete=Button(root,text="DELETE",bg="grey",fg="blue",font=("Arial",10),command=delete_data)
